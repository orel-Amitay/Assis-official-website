...
function LogoMark({ src, label, className = "" }: { src: string; label: string; className?: string }) {
  return (
    <span
      role="img"
      aria-label={label}
      title={label}
      className={`block bg-zinc-500 ${className}`}
      style={{
        maskImage: `url(${src})`,
...
function FieldMark({
  ...
  return (
    <motion.span
      className={`absolute text-zinc-500 ${className}`}
      title={label}
...
export default function Platforms() {
  ...
  return (
    <section id="install" className="relative scroll-mt-20 overflow-hidden py-16 sm:py-28">
      <div className="relative mx-auto max-w-5xl px-5 sm:px-10">
        ...
        <div className="mt-8 flex flex-col items-stretch justify-center gap-2.5 min-[400px]:flex-row min-[400px]:items-center sm:mt-12 sm:gap-2.5">
          <a
            ...
            className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-assis-blue px-5 text-sm font-semibold text-white transition-colors hover:bg-assis-blue-deep sm:h-10"
          >
            <ShopifyMark />
            Install on Shopify
          </a>
          <BookDemoButton className="inline-flex h-11 items-center justify-center rounded-full border border-zinc-200/80 bg-transparent px-5 text-sm font-semibold text-foreground transition-colors hover:bg-white/70 sm:h-10">
            Book a demo
          </BookDemoButton>
        </div>
        ...
        <div className="mt-10 sm:hidden">
          <div className="mx-auto max-w-sm">
            ...
            <div className="my-6 flex flex-col items-center justify-center">
              ...
              <p className="mt-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-assis-blue">
                Assis
              </p>
            </div>
            <div className="grid grid-cols-4 gap-x-3 gap-y-5">
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-[10px] font-bold uppercase tracking-[0.2em] text-assis-blue">
              Assis
            </p>
          </motion.div>
        </div>
